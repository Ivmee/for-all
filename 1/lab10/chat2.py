...
class ProjectileSimulator:
    ...
    def create_widgets(self):
        ...
        tk.Label(self.root, text="Масштаб (пикселей/м):").grid(row=2, column=0)
        ...
        self.scale_slider.grid(row=2, column=1)
    ...
    def simulate(self):
        ...
        while y >= 0:
            ...
            canvas_y = self.canvas_height - y * self.scale  # инвертируем y для экрана
